...
import Student from "../img/icons-img/student.png";
import Category from "../img/icons-img/category.png";
import Video from "../img/icons-img/video.png";
import BackgroundImage from "../img/fondo-about.jpg"; // Asegúrate de tener una imagen de fondo
import BackgroundImageAboutme from "../img/aboutme.svg"; // Asegúrate de tener una imagen de fondo
    ...
    <>
      ...
      <section className="text-justify max-w-7xl mx-auto mt-12 py-0 px-5">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-8 mt-12">
          ...
          <div className="md:w-1/2 pt-4">
            ...
            <p className="text-white">
              Una plataforma educativa dedicada a ofrecer cursos virtuales de alta
              calidad en diversas áreas del conocimiento. Nuestro objetivo es
              facilitar el aprendizaje accesible y flexible para todos,
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-white">
            "Nuestra visión es convertirnos en líderes globales en la educación
            online, ofreciendo una plataforma integral donde los estudiantes
            puedan acceder a cursos diversos y relevantes que impulsen su
